...
INSERT INTO `actuator` VALUES (1,'LedRojo',1),(2,'Dyson Pure',1),(3,'LG Confort S09',1),(4,'LedVerde',1);
...
INSERT INTO `actuator_value` VALUES (1,0,'Led',1621929600,1),(2,0,'Purifier',1621929600,2),(3,0,'AC',1621929600,3),(4,1,'Led',1621929600,4);
...
INSERT INTO `device` VALUES (1,'192.168.215.204','ESP8266',1),(2,'192.168.215.203','ESP8266',2);
...
INSERT INTO `room` VALUES (1,1621929600),(2,1621929600),(4,1621929600);
...
INSERT INTO `sensor` VALUES (1,'Sharp GP2Y1010',1),(2,'DHT22',1),(3,'DHT22',1);
...
INSERT INTO `sensor_value` VALUES (1,0,'Dust',1621929600,1),(2,0,'Temperature',1621929600,2),(3,0,'Humidity',1621929600,3);
...
CREATE TABLE `user_has_room` (
  ...
  KEY `fk_USER_has_ROOM_ROOM1_idx` (`ROOM_idRoom`),
  KEY `fk_USER_has_ROOM_USER1_idx` (`USER_idUser`),
  CONSTRAINT `fk_USER_has_ROOM_ROOM1` FOREIGN KEY (`ROOM_idRoom`) REFERENCES `room` (`idRoom`),
  CONSTRAINT `fk_USER_has_ROOM_USER1` FOREIGN KEY (`USER_idUser`) REFERENCES `user` (`idUser`)
...
-- Dump completed on 2021-05-25 23:19:35
