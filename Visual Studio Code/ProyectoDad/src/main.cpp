...
float humedad, temperatura, umbralHumedad = 55.0, umbralTemperatura = 23.0; 
...
String SERVER_IP = "192.168.215.203";  
int SERVER_PORT = 8080;

//- - - - - - - - - - VARIABLES PARA MQTT - - - - - - - - - -

const char* mqtt_server = "192.168.215.203"; 
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if(String(topic) == "purifier"){
    ...
    if(modeP == 1){
      ...
      Serial.println("Se ha apagado el PURIFICADOR mediante MQTT");
    }
